...
internal class IntialData
{
	public static IEnumerable<Customer> Customers =>
	new List<Customer>
	{
		Customer.Create(CoustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "mehmet", "mehmet@gmail.com"),
		Customer.Create(CoustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "john", "john@gmail.com")
	};
	...
	public static IEnumerable<Order> OrdersWithItems
	{
		get
		{
			...
			var order1 = Order.Create(
							...
							CoustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")),
							OrderName.Of("ORD_1"),
			...
			var order2 = Order.Create(
							OrderId.Of(Guid.NewGuid()),
							CoustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")),
							OrderName.Of("ORD_2"),
