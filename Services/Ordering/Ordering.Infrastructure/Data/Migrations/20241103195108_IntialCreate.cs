    ...
    public partial class IntialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CoustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    Payment_CartName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Payment_CartNumber = table.Column<string>(type: "nvarchar(24)", maxLength: 24, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Customers_CoustomerId",
